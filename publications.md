...
First author papers
======
- **Linear Maxwell-Vlasov in tritium mix <i>DT</i> fusion plasmas** ([here](./assets/img/nyp.png))
- **PIC simulations of aneutronic <i>D−3He</i> fusion plasmas** ([here](./assets/img/nyp.png))
- **Three ions (<i>DT-alpha</i>) in JET 26148** ([here](./assets/img/nyp.png)) 
